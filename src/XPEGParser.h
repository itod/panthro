...
enum {
    XPEG_TOKEN_KIND_GE_SYM = 14,
    XPEG_TOKEN_KIND_PIPE,
    XPEG_TOKEN_KIND_PRECEDING_SIBLING,
    XPEG_TOKEN_KIND_TRUE,
    XPEG_TOKEN_KIND_PARENT,
    XPEG_TOKEN_KIND_ATTRIBUTE,
    XPEG_TOKEN_KIND_MOD,
    ...
    XPEG_TOKEN_KIND_FOLLOWING_SIBLING,
    ...
    XPEG_TOKEN_KIND_PROCESSING_INSTRUCTION,
