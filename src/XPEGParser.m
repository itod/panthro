...
- (void)__simpleForClause {
    ...
    [self fireDelegateSelector:@selector(parser:didMatchSimpleForClause:)];
}

- (void)simpleForClause_ {
    [self parseRule:@selector(__simpleForClause) withMemo:_simpleForClause_memo];
}
