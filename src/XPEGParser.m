...
- (id)initWithDelegate:(id)d {
    ...
    if (self) {
        ...
        self.tokenKindTab[@"@"] = @(XPEGPARSER_TOKEN_KIND_ABBREVIATEDAXISSPECIFIER);
        ...
        self.tokenKindNameTab[XPEGPARSER_TOKEN_KIND_ABBREVIATEDAXISSPECIFIER] = @"@";
...
- (void)step_ {
    ...
    if ([self predicts:XPEGPARSER_TOKEN_KIND_ABBREVIATEDAXISSPECIFIER, XPEGPARSER_TOKEN_KIND_ANCESTOR, XPEGPARSER_TOKEN_KIND_ANCESTOR_OR_SELF, XPEGPARSER_TOKEN_KIND_ATTRIBUTE, XPEGPARSER_TOKEN_KIND_CHILD, XPEGPARSER_TOKEN_KIND_DESCENDANT, XPEGPARSER_TOKEN_KIND_DESCENDANT_OR_SELF, XPEGPARSER_TOKEN_KIND_FOLLOWING, XPEGPARSER_TOKEN_KIND_FOLLOWING_SIBLING, XPEGPARSER_TOKEN_KIND_NAMESPACE, XPEGPARSER_TOKEN_KIND_PARENT, XPEGPARSER_TOKEN_KIND_PRECEDING, XPEGPARSER_TOKEN_KIND_PRECEDING_SIBLING, XPEGPARSER_TOKEN_KIND_SELF, 0]) {
        ...
        [self stepBody_]; 
    } else if ([self predicts:XPEGPARSER_TOKEN_KIND_DOT, XPEGPARSER_TOKEN_KIND_DOT_DOT, 0]) {
...
- (void)axisPlusStepBody_ {
    ...
    [self fireDelegateSelector:@selector(parser:didMatchAxisPlusStepBody:)];
}
...
- (void)axisSpecifier_ {
    ...
    } else if ([self predicts:XPEGPARSER_TOKEN_KIND_ABBREVIATEDAXISSPECIFIER, 0]) {
        [self abbreviatedAxisSpecifier_]; 
    } else {
        [self raise:@"No viable alternative found in rule 'axisSpecifier'."];
    }

    [self fireDelegateSelector:@selector(parser:didMatchAxisSpecifier:)];
}
